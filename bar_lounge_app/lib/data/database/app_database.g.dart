...
class $TableReservationsTable extends TableReservations
  ...
  late final GeneratedColumn<int> clienteId = GeneratedColumn<int>(
    ...
    requiredDuringInsert: true,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'REFERENCES sesion_cliente (cliente_id)',
    ),
  );
  ...
  static const VerificationMeta _resDateMeta = const VerificationMeta(
    'resDate',
  );
  @override
  late final GeneratedColumn<DateTime> resDate = GeneratedColumn<DateTime>(
    'res_date',
    aliasedName,
    false,
    type: DriftSqlType.dateTime,
  ...
  static const VerificationMeta _resTimeMeta = const VerificationMeta(
    'resTime',
  );
  @override
  late final GeneratedColumn<String> resTime = GeneratedColumn<String>(
    'res_time',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  late final GeneratedColumn<String> guestsCount = GeneratedColumn<String>(
    'guests_count',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('res_date')) {
      context.handle(
        _resDateMeta,
        resDate.isAcceptableOrUnknown(data['res_date']!, _resDateMeta),
      );
    } else if (isInserting) {
      context.missing(_resDateMeta);
    }
    if (data.containsKey('res_time')) {
      context.handle(
        _resTimeMeta,
        resTime.isAcceptableOrUnknown(data['res_time']!, _resTimeMeta),
      );
    } else if (isInserting) {
      context.missing(_resTimeMeta);
    }
  ...
  TableReservation map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TableReservation(
      ...
      resDate:
          attachedDatabase.typeMapping.read(
            DriftSqlType.dateTime,
            data['${effectivePrefix}res_date'],
          )!,
      resTime:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}res_time'],
          )!,
      guestsCount:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
...
class TableReservation extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['res_date'] = Variable<DateTime>(resDate);
    map['res_time'] = Variable<String>(resTime);
    map['guests_count'] = Variable<String>(guestsCount);
  ...
  TableReservationsCompanion toCompanion(bool nullToAbsent) {
    return TableReservationsCompanion(
      ...
      specialRequests:
          specialRequests == null && nullToAbsent
              ? const Value.absent()
  ...
  factory TableReservation.fromJson(
    ...
    return TableReservation(
      ...
      resDate: serializer.fromJson<DateTime>(json['resDate']),
      resTime: serializer.fromJson<String>(json['resTime']),
      guestsCount: serializer.fromJson<String>(json['guestsCount']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'resDate': serializer.toJson<DateTime>(resDate),
      'resTime': serializer.toJson<String>(resTime),
      'guestsCount': serializer.toJson<String>(guestsCount),
  ...
  TableReservation copyWith({
    ...
    resDate: resDate ?? this.resDate,
    resTime: resTime ?? this.resTime,
    guestsCount: guestsCount ?? this.guestsCount,
    specialRequests:
        specialRequests.present ? specialRequests.value : this.specialRequests,
  ...
  TableReservation copyWithCompanion(TableReservationsCompanion data) {
    return TableReservation(
      ...
      resDate: data.resDate.present ? data.resDate.value : this.resDate,
      resTime: data.resTime.present ? data.resTime.value : this.resTime,
      guestsCount:
          data.guestsCount.present ? data.guestsCount.value : this.guestsCount,
      specialRequests:
          data.specialRequests.present
  ...
  String toString() {
    return (StringBuffer('TableReservation(')
          ...
          ..write('resDate: $resDate, ')
          ..write('resTime: $resTime, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is TableReservation &&
          ...
          other.resDate == this.resDate &&
          other.resTime == this.resTime &&
...
class TableReservationsCompanion extends UpdateCompanion<TableReservation> {
  ...
  final Value<DateTime> resDate;
  final Value<String> resTime;
  final Value<String> guestsCount;
  ...
  const TableReservationsCompanion({
    ...
    this.resDate = const Value.absent(),
    this.resTime = const Value.absent(),
  ...
  static Insertable<TableReservation> custom({
    ...
    Expression<DateTime>? resDate,
    Expression<String>? resTime,
    Expression<String>? guestsCount,
    ...
    return RawValuesInsertable({
      ...
      if (resDate != null) 'res_date': resDate,
      if (resTime != null) 'res_time': resTime,
  ...
  TableReservationsCompanion copyWith({
    ...
    Value<DateTime>? resDate,
    Value<String>? resTime,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (resDate.present) {
      map['res_date'] = Variable<DateTime>(resDate.value);
    }
    if (resTime.present) {
      map['res_time'] = Variable<String>(resTime.value);
    }
    if (guestsCount.present) {
      map['guests_count'] = Variable<String>(guestsCount.value);
    }
...
final class $$SesionClienteTableReferences
    extends
        BaseReferences<_$AppDatabase, $SesionClienteTable, SesionClienteData> {
  $$SesionClienteTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  _tableReservationsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.sesionCliente.clienteId,
          db.tableReservations.clienteId,
        ),
      );

  $$TableReservationsTableProcessedTableManager get tableReservationsRefs {
    final manager = $$TableReservationsTableTableManager(
      $_db,
      $_db.tableReservations,
    ).filter(
      (f) => f.clienteId.clienteId.sqlEquals($_itemColumn<int>('cliente_id')),
    );
...
class $$SesionClienteTableTableManager
    extends
        RootTableManager<
          ...
          (SesionClienteData, $$SesionClienteTableReferences),
          SesionClienteData,
          PrefetchHooks Function({bool tableReservationsRefs})
        > {
              ...
              (p0) =>
                  p0
                      .map(
                        (e) => (
                          e.readTable(table),
                          $$SesionClienteTableReferences(db, table, e),
                        ),
                      )
                      .toList(),
          prefetchHooksCallback: ({tableReservationsRefs = false}) {
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (tableReservationsRefs)
                    ...
                    >(
                      currentTable: table,
                      referencedTable: $$SesionClienteTableReferences
...
final class $$TableReservationsTableReferences
  ...
  static $SesionClienteTable _clienteIdTable(_$AppDatabase db) =>
      db.sesionCliente.createAlias(
        $_aliasNameGenerator(
          db.tableReservations.clienteId,
          db.sesionCliente.clienteId,
        ),
  ...
  $$SesionClienteTableProcessedTableManager get clienteId {
    final $_column = $_itemColumn<int>('cliente_id')!;

    final manager = $$SesionClienteTableTableManager(
      $_db,
      $_db.sesionCliente,
    ).filter((f) => f.clienteId.sqlEquals($_column));
...
class $$TableReservationsTableFilterComposer
  ...
  ColumnFilters<DateTime> get resDate => $composableBuilder(
    column: $table.resDate,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get resTime => $composableBuilder(
    column: $table.resTime,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get guestsCount => $composableBuilder(
  ...
  $$SesionClienteTableFilterComposer get clienteId {
    final $$SesionClienteTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.clienteId,
      referencedTable: $db.sesionCliente,
      getReferencedColumn: (t) => t.clienteId,
      builder:
          (
            joinBuilder, {
...
class $$TableReservationsTableOrderingComposer
  ...
  ColumnOrderings<DateTime> get resDate => $composableBuilder(
    column: $table.resDate,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get resTime => $composableBuilder(
    column: $table.resTime,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get guestsCount => $composableBuilder(
    column: $table.guestsCount,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  $$SesionClienteTableOrderingComposer get clienteId {
    final $$SesionClienteTableOrderingComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.clienteId,
      referencedTable: $db.sesionCliente,
      getReferencedColumn: (t) => t.clienteId,
...
class $$TableReservationsTableAnnotationComposer
  ...
  GeneratedColumn<DateTime> get resDate =>
      $composableBuilder(column: $table.resDate, builder: (column) => column);

  GeneratedColumn<String> get resTime =>
      $composableBuilder(column: $table.resTime, builder: (column) => column);

  GeneratedColumn<String> get guestsCount => $composableBuilder(
    column: $table.guestsCount,
    builder: (column) => column,
  );
  ...
  $$SesionClienteTableAnnotationComposer get clienteId {
    final $$SesionClienteTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.clienteId,
      referencedTable: $db.sesionCliente,
      getReferencedColumn: (t) => t.clienteId,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<DateTime> resDate = const Value.absent(),
                Value<String> resTime = const Value.absent(),
                Value<String> guestsCount = const Value.absent(),
                Value<String?> specialRequests = const Value.absent(),
                ...
                if (clienteId) {
                  state =
                      state.withJoin(
                            ...
                            referencedTable: $$TableReservationsTableReferences
                                ._clienteIdTable(db),
                            referencedColumn:
                                $$TableReservationsTableReferences
                                    ._clienteIdTable(db)
