...
/// Design System Colors — "The Digital Sommelier" / Obsidian & Ember
/// Extracted from the official DESIGN.md and Tailwind configs.
class AppColors {
  AppColors._();
  ...
  static const List<BoxShadow> ctaShadow = [
    BoxShadow(
      color: Color(0x4DFF6B00), // rgba(255,107,0,0.3)
      blurRadius: 20,
      offset: Offset(0, 10),
    ),
  ];
  ...
  // ── Glass Effects ──────────────────────────────────────────
  static const Color glassCardBg = Color(0x33353943); // rgba(53,57,67,0.2)
  static const Color glassPanelBg = Color(0x99262A34); // rgba(38,42,52,0.6)
}
