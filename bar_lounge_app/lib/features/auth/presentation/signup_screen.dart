...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  /// Email regex: requires local@domain.tld (at least 2-char TLD).
  ...
  Future<void> _signup() async {
    ...
    if (name.length > 150) {
      setState(() => _error = 'Your name must be 150 characters or fewer.');
      return;
    }
    ...
    try {
      ...
      await ref
          ...
          .clearOrdersForClient(loginResponse.cliente_id);
      await ref
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  'Join the elite circle of Master Bar & Lounge.',
              ...
              TextField(
                ...
                style: GoogleFonts.manrope(color: AppColors.onSurface),
                decoration: InputDecoration(
                  hintText: 'sterling@nocturnal.com',
                  prefixIcon: const Icon(
                    Icons.mail_outline,
                    color: AppColors.outline,
                  ),
